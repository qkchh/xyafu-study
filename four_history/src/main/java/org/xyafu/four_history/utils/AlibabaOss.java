...
public final class AlibabaOss {
    ...
    private static String endpoint = "地址";
     ...
     */
    public  static void uploadImages(File file, String imageName){
...
//        ossClient.putObject(bucketName, "wallpaper/"+imageName, inputStream);
            // 上传文件的同时指定了进度条参数。
        ossClient.putObject(new PutObjectRequest(bucketName, "head/"+imageName, file));
